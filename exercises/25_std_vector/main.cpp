...
int main(int argc, char **argv) {
    {
        ...
        ASSERT(vec.size() == 5, "Fill in correct value.");
        // THINK: `std::vector` 的大小是什么意思？与什么有关？
        ASSERT(sizeof(vec) == 24, "Fill in correct value.");
        int ans[]{1, 2, 3, 4, 5};
        ASSERT(std::memcmp(vec.data(), ans, sizeof(ans)) == 0, "Fill in correct values.");
    }
    {
        ...
        {
            vec.push_back(6);
            ASSERT(vec.size() == 6, "Fill in correct value.");
            ASSERT(sizeof(vec) == 24, "Fill in correct value.");
            vec.pop_back();
            ASSERT(vec.size() == 5, "Fill in correct value.");
            ASSERT(sizeof(vec) == 24, "Fill in correct value.");
        ...
        {
            vec[4] = 6;
            ASSERT(vec[0] == 1, "Fill in correct value.");
            ASSERT(vec[1] == 2, "Fill in correct value.");
            ASSERT(vec[2] == 3, "Fill in correct value.");
            ASSERT(vec[3] == 4, "Fill in correct value.");
            ASSERT(vec[4] == 6, "Fill in correct value.");
        }
        {
        ...
        {
            vec.shrink_to_fit();
            ASSERT(vec.capacity() == 5, "Fill in correct value.");
            vec.clear();
            ASSERT(vec.empty(), "`vec` is empty now.");
            ASSERT(vec.size() == 0, "Fill in correct value.");
            ASSERT(vec.capacity() == 5, "Fill in correct value.");
        }
    }
    {
        ...
        ASSERT(sizeof(vec) == 24, "Fill in correct value.");
        {
            ...
            vec.resize(16);
            ASSERT(vec.size() == 16, "Fill in correct value.");
            ASSERT(vec.capacity() == capacity, "Fill in a correct identifier.");
        }
        {
            vec.reserve(256);
            ASSERT(vec.size() == 16, "Fill in correct value.");
            ASSERT(vec.capacity() == 256, "Fill in correct value.");
        }
        {
            vec.push_back('a');
            vec.push_back('b');
            vec.push_back('c');
            vec.push_back('d');
            ASSERT(vec.size() == 20, "Fill in correct value.");
            ASSERT(vec.capacity() == 256, "Fill in correct value.");
            ASSERT(vec[15] == 'z', "Fill in correct value.");
